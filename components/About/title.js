...
export default function AboutTitle() {
  return (
    <div className="w-full h-full bg-[#e8f5fc] px-[24px] sm:px-16 lg:px-32 xl:px-52 2xl:px-80 py-12 sm:py-20 lg:py-24 xl:py-32">
      <div className="w-full lg:flex items-center gap-x-[5rem] xl:gap-x-[6rem]">
        <div className="w-full grid justify-items-start gap-y-6 sm:gap-y-7 lg:gap-y-6 pb-10 sm:pb-14 lg:pb-0">
