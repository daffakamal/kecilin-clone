    ...
    <div className="w-full h-full bg-[#EAF7FE] px-[24px] sm:px-16 lg:px-32 xl:px-52 2xl:px-80 py-12 sm:py-20 lg:py-24 xl:py-32 gap-y-[6rem]">
      <div className="mx-auto container">
        ...
        <div className="grid justify-items-center lg:flex justify-center mx-auto gap-x-[2rem] xl:gap-x-[3rem] 2xl:gap-x-[4rem] gap-y-[3rem] pt-20">
          <div className="w-auto grid text-left lg:text-left content-start gap-y-6">
            <h1 className="font-PoppinsSemi text-[28px] text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-900">
          ...
          <div className="w-full grid max-w-[280px] sm:max-w-[360px] lg:max-w-[250px] xl:max-w-[290px]">
            ...
            <div className="grid justify-items-center bg-white p-[1.5rem] gap-y-[1rem] font-PoppinsLight text-[#2F3D4D] text-[18px]">
              ...
              <h1 className="font-PoppinsSemi text-[20px]">AVERAGE 4.5 Mbps</h1>
            </div>
          </div>
          <div className="w-full grid max-w-[280px] sm:max-w-[360px] lg:max-w-[250px] xl:max-w-[290px]">
            <Image
            ...
            <div className="grid justify-items-center bg-white p-[1.5rem] gap-y-[1rem] font-PoppinsLight text-[#2F3D4D] text-[18px]">
              ...
              <h1 className="font-PoppinsSemi text-[20px]">AVERAGE 1.1 MBPS</h1>
            </div>
          </div>
        </div>
      </div>
