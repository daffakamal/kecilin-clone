...
export default function Title() {
  return (
    <div className="w-full grid content-center min-h-full md:min-h-[30vh] lg:min-h-[22vh] 2xl:min-h-[50vh] bg-white px-[24px] sm:px-16 pt-0 md:pt-16 pb-12 sm:pb-14 md:pb-16 g:py-24 xl:py-32">
      <div className="mx-auto large:max-w-[1100px] md:flex items-center gap-x-10 lg:gap-x-[4rem]">
        <Image
          src={TitleImg.src}
          className="mx-auto w-[300px] xs:w-[340px] md:w-[300px] lg:w-[480px] xl:w-[500px] 3xl:w-auto pointer-events-none"
          width={554}
          height={554}
          loading="lazy"
        ...
        <div className="w-full grid content-center">
          ...
          <div className="pt-[2.5rem] lg:pt-[3rem] grid gap-y-4">
            {enterpriseList.map((item) => (
              <ul key={item.id} className="w-full flex gap-x-3 m-auto">
                <Image
                  src={ChecklistImg.src}
                  className="w-6 lg:w-7 my-auto pointer-events-none"
                  width={32}
                  height={32}
                  alt="Checklist"
                  loading="lazy"
                />
                <li className="w-fit font-PoppinsRegular text-[18px] lg:text-[20px] text-[#494949]">
                  {item.description}
                </li>
              </ul>
            ))}
