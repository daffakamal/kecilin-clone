...
function Navbar() {
  ...
  const styleTextNav =
    "font-PoppinsRegular lg:text-sm xl:text-sm cursor-pointer text-black hover:text-cyan-600 px-3 py-2";
  ...
  return (
    <nav className="w-full bg-white drop-shadow-xl lg:pt-1 lg:pb-1 px-7 sm:px-16 z-50">
      <div className="w-full xl:mx-auto large:max-w-[1200px]">
        <div className="w-full flex items-center h-12 md:h-14 xl:h-20">
          <div className="w-full flex items-center justify-between lg:justify-start gap-x-14">
            ...
            <div className="hidden lg:flex justify-start">
              <div className="flex space-x-2 lg:space-x-6 2xl:space-x-11">
                ...
                <Menu as="div" className="relative inline-block text-left">
                  <div className="flex items-center text-black hover:text-cyan-600">
                    <Menu.Button className={styleTextNav}>English</Menu.Button>
                    <ChevronDownIcon className="w-4" />
                  </div>
                  <Transition
                    as={Fragment}
          ...
          <div className="hidden lg:flex min-w-fit justify-center items-center">
            <Link href="/#compress-page">
              <button className="font-PoppinsMedium text-white uppercase px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-900 rounded-full text-xs cursor-pointer">
                Compress now
              </button>
            </Link>
          </div>
        ...
        <div className="block md:hidden" id="mobile-menu">
          <div className="w-full grid">
            ...
            <div className="flex justify-end pt-1 pb-3">
              <Link href="/#compress-page">
                <button className="font-PoppinsMedium text-white uppercase px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-900 rounded-full text-[11px] cursor-pointer">
                  Compress now
                </button>
              </Link>
            </div>
        ...
        <div className="hidden md:block lg:hidden" id="mobile-menu">
          <div className="w-full grid content-center">
            ...
            <div className="flex justify-end py-3">
              <Link href="/#compress-page">
                <button className="font-PoppinsMedium text-white uppercase px-5 py-2 bg-gradient-to-r from-cyan-600 to-blue-900 rounded-full text-[12px] cursor-pointer">
                  Compress now
                </button>
              </Link>
            </div>
