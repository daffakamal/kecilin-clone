...
export default function HomeChart() {
    return (
      <div className="w-full h-full bg-white">
        <div className="w-full px-[24px] sm:px-16 py-20">
          <div className="large:max-w-[1100px] mx-auto grid gap-y-36">
            <div
              ...
              <Image
                src={ChartImg1.src}
                className="mx-auto w-11/12 xs:w-3/4 md:w-7/12 2xl:w-[500px] pointer-events-none"
                width={550}
                height={364}
                loading="lazy"
                alt="Chart"
              ...
              <p className="font-PoppinsRegular text-[16px] xs:text-[22px] text-[#383838] pt-8 xs:pt-12 md:pt-0 lg:pt-3 md:translate-y-9">
                Almost 90% of enterprises are have already adopted digital
                transformation, including financial services (93%)
              </p>
            </div>
            <div
              className="grid md:flex gap-x-3 xl:gap-x-16 items-start"
              ...
              <div className="grid gap-y-12 pb-12 md:pb-0">
                <p className="font-PoppinsRegular text-[16px] xs:text-[22px] text-[#383838] pt-8 xs:pt-12">
                  90% of all data today was created in the past 2 yrs. It is
            ...
            <div
              ...
              <div className="grid">
                <p className="font-PoppinsRegular text-[16px] xs:text-[22px] text-[#383838] pt-8 xs:pt-12 pb-5">
                  14% growth of Hardware & Cloud Storage, Network & Bandwidth
                  Growth up to 6%.
                </p>
