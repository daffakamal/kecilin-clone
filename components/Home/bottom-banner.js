  ...
  return (
    <div className="w-full bg-bottom-banner bg-cover">
      <div className="mx-auto relative w-10/12 xl:w-3/4 py-[150px] text-white">
        <h2
          className="flex flex-wrap items-center font-PoppinsBold text-[26px] xs:text-[36px] md:text-[64px] drop-shadow-text-banner mb-[30px]"
          data-aos="fade-up"
        ...
        <h4
          className="font-PoppinsMedium text-[16px] xs:text-[20px] md:text-[28px] mb-[30px]"
          data-aos="fade-up"
          data-aos-easing="ease"
          data-aos-duration="400"
          data-aos-delay="100"
        ...
        <p
          className="font-PoppinsRegular text-[11px] xs:text-[12px] md:text-[14px]"
          data-aos="fade-up"
          data-aos-easing="ease"
          data-aos-duration="400"
          data-aos-delay="100"
