...
export default function HomeData() {
    return (
        <div className="w-full bg-[#dcf1fc] py-[55px]">
            <div className="w-full px-[24px] sm:px-16 lg:px-32 xl:px-52 2xl:px-80 pt-5">
                <div className="grid justify-items-center md:flex gap-y-10 md:gap-y-0 md:gap-x-10 xl:gap-x-14">
