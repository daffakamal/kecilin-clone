        ...
        <div className="w-full pb-14 md:pb-20 lg:pb-32">
          <div className="relative overflow-hidden">
            ...
            <div className="w-full h-full absolute top-0 right-0 bottom-0 left-0 overflow-hidden bg-fixed">
              <div className="h-full flex justify-start items-center px-[24px] sm:px-16 lg:px-32 xl:px-52 2xl:px-80 xl:mx-auto large:max-w-[1800px] py-[149px]">
                <div className="w-full text-white space-y-2 xl:space-y-5">
