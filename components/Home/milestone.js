...
const styleDescIcon =
  "w-fit sm:pl-2 xl:pl-4 2xl:pl-6 translate-x-20 xl:translate-x-16 font-PoppinsRegular text-[16px] sm:text-[18px] text-[#6D6D6D]";

export default function Milestone() {
    return (
      <div className="w-full h-full bg-[#f9fafb]">
        <div className="w-full px-[24px] sm:px-16 py-[110px]">
          <div className="grid justify-items-start px-2 xl:px-5 lg:py-6 large:max-w-[1100px] mx-auto">
            <div
              className="grid justify-items-center md:flex gap-x-10 3xl:gap-x-6"
              data-aos="fade-up"
              data-aos-easing="ease"
              data-aos-duration="400"
              data-aos-delay="0">
              <h1 className="w-full md:w-2/3 font-PoppinsSemi text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-900 text-[28px] xs:text-[32px] xl:text-[40px] text-center md:text-left">
                {"Let's"} Get to Know Kecilin!
              </h1>
              <p className="w-full font-PoppinsLight text-[16px] xs:text-[20px] text-[#6D6D6D] pt-6 md:pt-0 text-justify">
            ...
            <div
              className="w-full flex flex-wrap lg:flex-nowrap justify-between gap-y-8 md:gap-y-7 gap-x-10 md:gap-x-0"
              data-aos="fade-up"
              data-aos-easing="ease"
              data-aos-duration="400"
              data-aos-delay="0">
              ...
              <div className="w-full flex flex-col max-w-[260px]">
                <div className="flex items-center gap-x-6">
                  <Image
                    src={CloudIcon.src}
                    className="w-14 sm:w-16 xl:w-14 2xl:w-16 pointer-events-none"
